    ...
    >
      ...
      <ArticleSection id="fiber" title="2. 차세대 영양소, 식이섬유">
        <p>
          ...
          프리바이오틱스 기반 탄산음료, 이눌린이 첨가된 파스타와 베이글,
          식이섬유 강화 시리얼이 인기를 얻을 전망입니다.
        </p>
        <p>
          장 건강의 중요성이 널리 알려지면서, 소비자들은 단순히 칼로리와
          단백질만 따지던 습관에서 벗어나 식이섬유 함량까지 꼼꼼히 확인하기
          시작했습니다.
        </p>
      </ArticleSection>
      ...
      <ArticleSection id="frozen" title="4. 냉동 식품의 미식화">
        ...
        <p>
          1인 가구 증가와 맞물려 덮밥류(+8.2%), 샐러드(+22.2%), 비빔밥(+13.7%)
          등 한 그릇에 영양 균형을 맞춘 프리미엄 간편식의 성장이 두드러집니다.
        </p>
      </ArticleSection>
