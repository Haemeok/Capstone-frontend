    ...
    <ArticleLayout title="개인정보 처리방침" subtitle="정책" date="2026. 1. 20">
      ...
      <ArticleSection title="제1조 (개인정보의 처리 목적)">
        ...
        <ol className="list-decimal space-y-2 pl-5">
          <li>
            홈페이지 회원가입 및 관리: 소셜 로그인(SNS)을 통한 본인 식별·인증,
            회원 자격 유지·관리, 서비스 부정이용 방지, 각종 고지·통지
          </li>
          <li>
            재화 또는 서비스 제공: 레시피 추천 및 관리 서비스 제공, 콘텐츠 제공
          </li>
          <li>
            서비스 개선 및 신규 서비스 개발: 서비스 이용 기록과 접속 빈도 분석,
            서비스 이용에 대한 통계, 서비스 분석 및 맞춤형 서비스 제공
          </li>
        </ol>
      </ArticleSection>
      ...
      <ArticleSection title="제4조 (개인정보의 파기 절차 및 방법)">
        ...
        <ol className="list-decimal space-y-2 pl-5">
          ...
          <li>
            파기 방법: 전자적 파일 형태로 기록·저장된 개인정보는 기록을 재생할
      ...
      <ArticleSection title="제6조 (개인정보의 안전성 확보 조치)">
        ...
        <ol className="list-decimal space-y-2 pl-5">
          <li>
            관리적 조치: 내부관리계획 수립·시행, 개인정보 취급 직원 최소화 및
            교육
          </li>
          <li>
            기술적 조치: 개인정보처리시스템 등의 접근권한 관리, 접근통제시스템
            설치, 고유식별정보 등의 암호화(SSL 인증서 설치 등), 보안프로그램
            설치
          </li>
          <li>
      ...
      <ArticleSection title="제7조 (개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)">
        ...
        <p>
          ② 쿠키는 이용자의 브라우저에 저장되며, 로컬 스토리지는 이용자의 기기
          내에 저장됩니다.
        </p>
        <p>
          ③ 거부 설정: 웹브라우저 상단의 도구 &gt; 인터넷 옵션 &gt; 개인정보
          메뉴의 옵션 설정을 통해 저장 거부를 설정할 수 있습니다. 단, 거부할
          경우 로그인이 필요한 일부 서비스 이용에 어려움이 발생할 수 있습니다.
        </p>
      </ArticleSection>
      ...
      <ArticleSection title="제8조 (행태정보의 수집·이용 및 거부 등에 관한 사항)">
        ...
        <ol className="list-decimal space-y-2 pl-5">
          <li>도구명: PostHog</li>
          <li>
            수집 항목: 이용자의 웹/앱 서비스 방문 기록, 기능 클릭수, 체류 시간,
            기기 정보 (단, 이용자가 입력하는 민감한 개인정보 및 화면 녹화
            데이터는 수집하지 않습니다.)
          </li>
          <li>
          ...
          <li>
            보유 및 이용 기간: 회원 탈퇴 또는 서비스 종료 시까지 (단, 통계 분석
            데이터는 비식별화하여 보관)
          </li>
        </ol>
        <p>
          ② 이용자는 브라우저의 &#39;Do Not Track(추적 금지)&#39; 설정을 통해
          이러한 행태정보 수집을 거부할 수 있습니다.
        </p>
      </ArticleSection>
      ...
      <ArticleSection title="제9조 (개인정보의 국외 이전)">
        ...
        <ol className="list-decimal space-y-2 pl-5">
          ...
          <li>이전되는 국가: 미국 (US)</li>
          <li>이전 일시 및 방법: 서비스 이용 시 네트워크를 통해 수시로 전송</li>
          <li>
