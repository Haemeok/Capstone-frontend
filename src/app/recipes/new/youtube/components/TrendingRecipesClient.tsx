...
const SCROLL_UPDATE_DELAY_MS = 300;
...
export const TrendingRecipesClient = ({
  ...
  const handlePrev = () => {
    ...
    setTimeout(updateScrollButtons, SCROLL_UPDATE_DELAY_MS);
  };
      ...
      >
        {recipes.length === 0 ? (
          ...
          recipes.map((recipe) => (
            ...
            >
              <div className="group-hover:border-olive-light cursor-pointer relative mb-2 aspect-video w-full overflow-hidden rounded-lg border border-gray-200 bg-gray-100 transition-colors">
                <Image
