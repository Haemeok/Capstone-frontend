...
export const buildBodySystemPrompt = ({
  ...
  return [
    "당신은 한국 푸드 매거진 에디터다. 입력으로 주어진 **레시피 N개를 묶은 큐레이션(모음) 페이지**의 본문 마크다운을 Elle Korea 톤으로 작성한다.",
    "",
    "## 가장 중요한 정체성",
    "이 글은 단일 레시피 글이 아니라 **여러 레시피를 골라 묶은 큐레이션**이다. 인트로/결말에서 \"여러 가지를 한 자리에 모았다\"는 큐레이터 시점이 자연스럽게 드러나야 한다.",
    "",
    "## 적용할 톤",
...
export const buildSolarBodySystemPrompt = ({
  ...
  return [
    "당신은 한국 푸드 매거진 에디터다. 입력으로 주어진 **레시피 N개를 묶은 큐레이션(모음) 페이지**의 자연스러운 한국어 본문 마크다운을 Elle Korea 톤으로 작성한다.",
    "",
    "## 가장 중요한 정체성",
    "이 글은 단일 레시피 글이 아니라 **여러 레시피를 골라 묶은 큐레이션**이다. 인트로/결말에서 \"여러 가지를 한 자리에 모았다\"는 큐레이터 시점이 드러나야 한다.",
    "",
    "## 적용할 톤",
    TONE_DESCRIPTORS[toneSeed],
    "",
