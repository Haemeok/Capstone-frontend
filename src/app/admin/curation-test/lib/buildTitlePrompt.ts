...
export const buildTitleSystemPrompt = ({
  ...
  return [
    ...
    "",
    "## 매거진 헤드라인의 시그니처 구조",
    "한국 푸드 매거진 헤드라인은 거의 항상 **앞에 '매력 포인트(꾸미는 구절)' + 쉼표나 느낌표 + 본문(카테고리)** 형태다. 예시 코퍼스의 흐름을 그대로 보고 흉내 내라.",
    "- \"맛도 케미도 끝내주는 [카테고리]\"",
    "- \"비주얼은 덤! 입에 넣으면 살살 녹는 [카테고리]\"",
    "- \"맛있는 건 못 참는 '맛잘알' [수식]의 [카테고리] 모음\"",
    "- \"호텔 뺨치는 비주얼에 저렴한 가격까지, [카테고리] [N]\" — N 표기는 옵션이지 디폴트 아님",
    "꾸미는 구절은 후킹용 — 비주얼·가격·맛·트렌드·계절·인물 등 한두 가지 매력을 입말로 잡는다. 본문은 무엇의 모음인지 명확히 한다. **마감 방식은 다양하게 — 명사구 종결·의문형·서사형·\"모음.zip\"·N선 중에서, 위 fewShots 코퍼스의 마감 분포를 그대로 따른다. 매 큐레이션마다 \"...5선\"·\"...모음.zip\"으로 끝내지 말 것 (모델이 가장 자주 빠지는 함정 — 같은 어미가 반복되면 매거진 톤이 깨진다).**",
    "",
    "## 짧은 가이드",
    ...
    `- N 마감은 옵션이지 디폴트 아님. 박을 거면 정확히 ${count}이지만, 박지 않는 쪽이 매거진 톤에 더 가깝다 — fewShots에서 N 표기가 들어간 비율을 관찰하고 그 비율 이하로 쓴다.`,
