...
export const KO_ONLY_DIRS = [
  ...
  "src/app/archetype",
  "src/app/curation",
  "src/app/recipes/[recipeId]/reviews",
  "src/features/archetype",
  "src/features/curation",
  "src/features/events/ui/AppInstallActions.tsx",
  "src/features/events/ui/AppInstallEventView.tsx",
  "src/features/events/ui/CookingRecordEventCta.tsx",
  "src/features/events/ui/CookingRecordEventView.tsx",
  "src/features/cooking-record-launch/ui/CookingRecordLaunchDrawer.tsx",
