...
export const searchDiscovery: SearchDiscoveryDict = {
  ...
  seasonalPopularTitle: "Popular recipes with seasonal {ingredient}",
  quickPopularTitle: "Popular recipes ready in {minutes} min",
  categoryPopularTitle: "How about {category} today?",
  ...
  youtubeVerifiedTitle: "Recipes proven by 10M+ YouTube views",
