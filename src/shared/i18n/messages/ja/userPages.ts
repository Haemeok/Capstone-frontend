  ...
  calendar: {
    ...
    cookingRecord: {
      ...
      background: {
        title: "背景を変える",
        closeLabel: "背景選択を閉じる",
        monthOnlyLabel: "{month}だけに適用されます",
        intro: "今月の料理に合う背景を選んでください。",
