...
export const END_POINTS = {
  ...
  COMMENT_IMAGE_UPLOAD_URLS: (recipeId: string) =>
    `/recipes/${recipeId}/comments/image-upload-urls`,
  ...
  RECIPE_TITLE_KEYWORD: (id: string) => `/recipes/${id}/title-keyword`,
  ...
  REVIEW_REPORTS: (reviewId: string) => `/reviews/${reviewId}/reports`,
  RATING: (recipeId: string) => `/ratings/recipe/${recipeId}`,
  RECIPE_REPORTS: (recipeId: string) => `/recipes/${recipeId}/reports`,
  LOGOUT: "/token/logout",
  DELETE_ACCOUNT: "/me",
