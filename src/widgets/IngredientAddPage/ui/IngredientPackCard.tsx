...
export const IngredientPackCard = ({
  ...
  return (
    ...
    >
      ...
      <span className="text-ink-sub mt-1 line-clamp-1 block text-xs">
        {meta.description}
      </span>
      <span className="text-ink-sub mt-1.5 block text-xs">
        {allOwned
          ? dict.cardOwned
