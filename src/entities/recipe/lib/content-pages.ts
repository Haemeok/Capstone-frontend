...
export const PRICE_RANGES = [
  {
    ...
    description: "가성비 최고",
    maxCost: 5000,
    imageUrl: "/images/search-price-range/under-5000.png",
  },
  {
    id: "under-10000",
    label: "1만원 이하",
    description: "합리적인 가격",
    maxCost: 10000,
    imageUrl: "/images/search-price-range/under-10000.png",
  },
  {
    id: "under-20000",
    label: "2만원 이하",
    description: "든든한 한끼",
    maxCost: 20000,
    imageUrl: "/images/search-price-range/under-20000.png",
  },
  {
    id: "premium",
    label: "프리미엄",
    description: "특별한 날",
    minCost: 20000,
    imageUrl: "/images/search-price-range/premium.png",
  },
];
