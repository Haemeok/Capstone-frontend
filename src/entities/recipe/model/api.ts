...
export const getCookedPopularRecipes = async (
  lang: Locale = "ko"
...
export const getFridgeIngredientPopularRecipes = async (
  lang: Locale = "ko"
): Promise<FridgeIngredientPopularResponse> => {
  return api.get<FridgeIngredientPopularResponse>(
