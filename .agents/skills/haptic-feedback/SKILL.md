...
description: Recipio Web-to-React Native WebView haptic guidelines. Use when creating or modifying buttons, toggles, sliders, tabs, form submissions, or other user-triggered UI interactions that call the native bridge.
license: MIT
metadata:
  author: recipio
  version: "2.0.0"
